...
import { listMedications, addMedication, patchMedication, removeMedication, listReminders, addReminder, patchReminder, removeReminder, } from '../controllers/medicationsController.js';
const router = Router();
